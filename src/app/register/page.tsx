  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-2 text-gray-900">GlamWorld</h1>
        <p className="text-center text-gray-600 mb-6 text-sm">
          Create your contestant account
        </p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2 text-sm text-gray-800 font-medium hover:bg-gray-50 transition"
        >
